...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 08, 2018 at 08:46 PM
...
INSERT INTO `answertbl` (`idanswer`, `answertitle`) VALUES
(1, 'c++'),
(2, 'java'),
(3, 'c++'),
(4, 'java');
...
(6, 'IT 211 CLS', 'capstone implementation', 'comlab');
...
--
-- Dumping data for table `questionaire_typetbl`
--

INSERT INTO `questionaire_typetbl` (`idquestiontype`, `questionaire_type_title`, `questionare_type`, `questionaire_type_total_score`, `questionaire_type_score`, `idquestionaire_type_questions`) VALUES
(1, 'ComProg1 prelim', '2', '2', '1', 1);
...
INSERT INTO `questiontbl` (`idquestion`, `question_id`, `question_title`, `question_points`, `idquestion_answer`) VALUES
(1, 0, 'What is programming language', '2', 1);
...
--
-- Dumping data for table `question_answerlisttbl`
--

INSERT INTO `question_answerlisttbl` (`idquestion_answerlist`, `question_answer_id`, `question_answer_description`) VALUES
(1, 0, 'c++'),
(2, 0, 'python');
...
(24, 36, 'qq', 'qq', 'qq', 0, '', 0, ''),
(25, 37, 'qq', 'qq', 'qq', 0, '', 0, ''),
(26, 39, '232', '323', '2323', 0, '', 2323, ''),
(31, 44, '11', '111', '11', 0, '', 11, ''),
(32, 45, '55', '5', '55', 0, '', 55, '');
...
(7, 'IT - 222', 'Capstone Project', 8, 2, ''),
(8, 'IT 111', 'SOFT ENG', 9, 3, '');
...
(8, 'MORNING CAPSTONE', 'Monday', '10:34', '11:34', 'unavailable'),
(9, 'afternoon it', 'Tuesday,Thursday', '01:20', '02:30', 'unavailable');
...
(2, 29, 'dfg', 'dfg', 'dfg', 0, 'dfgs', NULL, NULL, ''),
(4, 33, 'rodgie', 'edig', 'barnuevo', 0, 'program head', NULL, NULL, ''),
(8, 46, 'u', 'u', 'u', 0, 'u', NULL, NULL, ''),
(9, 47, 'u', 'u', 'u', 0, 'u', NULL, NULL, ''),
(10, 48, 'u', 'u', 'u', 0, 'u', NULL, NULL, ''),
(11, 49, 'u', 'u', 'u', 0, 'u', NULL, NULL, ''),
(12, 50, 'u', 'u', 'u', 0, 'u', NULL, NULL, ''),
(13, 51, 'u', 'u', 'u', 0, 'u', NULL, NULL, ''),
(14, 52, 'u', 'u', 'u', 0, 'u', NULL, NULL, ''),
(15, 53, 'u', 'u', 'u', 0, 'u', NULL, NULL, ''),
(16, 54, 'pp', 'pp', 'pp', 0, 'pp', NULL, NULL, ''),
(17, 55, 'oo', 'o', 'o', 0, 'oo', NULL, NULL, ''),
(18, 56, 'oo', 'o', 'o', 0, 'oo', NULL, NULL, ''),
(19, 57, 'oo', 'o', 'o', 0, 'oo', NULL, NULL, ''),
(20, 58, 'oo', 'o', 'o', 0, 'oo', NULL, NULL, '');
...
(33, 'test-teacher', 'fritz', 'asdf', 2, 'active', '2018-01-08 10:07:36', '0000-00-00 00:00:00'),
(36, '2151', 'qq', '2151', 1, 'inactive', '2018-01-08 09:44:07', '0000-00-00 00:00:00'),
(37, '2151', 'qq', '2151', 1, 'inactive', '2018-01-08 09:44:09', '0000-00-00 00:00:00'),
(39, '2323', '23232323', '2323', 1, 'inactive', '2018-01-08 09:45:03', '0000-00-00 00:00:00'),
(44, '111', '11', '111', 1, 'inactive', '2018-01-08 09:48:16', '0000-00-00 00:00:00'),
(45, '55', '5', '55', 1, 'inactive', '2018-01-08 09:49:30', '0000-00-00 00:00:00'),
(46, 'u', 'u', 'u', 2, 'inactive', '2018-01-08 18:52:22', '0000-00-00 00:00:00'),
(47, 'u', 'u', 'u', 2, 'inactive', '2018-01-08 18:52:26', '0000-00-00 00:00:00'),
(48, 'u', 'u', 'u', 2, 'inactive', '2018-01-08 18:52:27', '0000-00-00 00:00:00'),
(49, 'u', 'u', 'u', 2, 'inactive', '2018-01-08 18:52:28', '0000-00-00 00:00:00'),
(50, 'u', 'u', 'u', 2, 'inactive', '2018-01-08 18:52:29', '0000-00-00 00:00:00'),
(51, 'u', 'u', 'u', 2, 'inactive', '2018-01-08 18:52:30', '0000-00-00 00:00:00'),
(52, 'u', 'u', 'u', 2, 'inactive', '2018-01-08 18:52:31', '0000-00-00 00:00:00'),
(53, 'u', 'u', 'u', 2, 'inactive', '2018-01-08 18:52:32', '0000-00-00 00:00:00'),
(54, 'pp', 'pp', 'pp', 2, 'inactive', '2018-01-08 19:08:45', '0000-00-00 00:00:00'),
(55, 'oo', 'oo', 'oo', 2, 'inactive', '2018-01-08 19:41:03', '0000-00-00 00:00:00'),
(56, 'oo', 'oo', 'oo', 2, 'inactive', '2018-01-08 19:42:01', '0000-00-00 00:00:00'),
(57, 'oo', 'oo', 'oo', 2, 'inactive', '2018-01-08 19:44:01', '0000-00-00 00:00:00'),
(58, 'oo', 'oo', 'oo', 2, 'inactive', '2018-01-08 19:45:00', '0000-00-00 00:00:00');
...
--
ALTER TABLE `student_informationtbl`
  MODIFY `idstudent` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `teacher_informationtbl`
  MODIFY `idteacher` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `users`
--
ALTER TABLE `users`
  MODIFY `idusers` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
...
--
ALTER TABLE `user_coursetbl`
  MODIFY `usercourse_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;

--
-- AUTO_INCREMENT for table `user_departmenttbl`
--
ALTER TABLE `user_departmenttbl`
  MODIFY `iduser_department` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
...
--
ALTER TABLE `user_subjecttbl`
  MODIFY `iduser_subject` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
